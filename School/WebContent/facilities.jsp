...
props.load(stream);
String facilityArray = props.getProperty("facilities");
JSONArray facilityJsonArray= new JSONArray(facilityArray);
int length = facilityJsonArray.length();
		...
		<div class="main-content">
			<div class="panel-group" id="accordion">
				...
				<%
					...
					JSONObject jo = (JSONObject) facilityJsonArray.get(index);
				%>
				<div class="panel">
				...
				<div class="panel-body left"><img src="<%out.print(jo.get("link"));%>" alt=""></div>
						<div class="panel-body justify right"><%out.print(jo.get("info"));%></div>
					</div>
				</div>
			</c:forEach>
